...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ti.redlaser.js')
	...
	f = os.path.join(cwd,'Classes','TiRedlaserModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ti.redlaser.js']
